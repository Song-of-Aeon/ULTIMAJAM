...
function c_bang(x, y, direction, width, delay, duration_or_decay, type, color=c_white, behavior=c_null, length=DIAGONAL*2, draw=c_hitscandraw, additive_=false) {
