function c_clearrect(x_, y_, x2, y2, strong=false, includemine=false, whattodo=instance_destroy) {
	//do you think i care
...
function c_clearline(x, y, x2, y2, strong=false, includemine=false, whattodo=instance_destroy) {
