...
function bullet(name_, sprite_=s_bulcircle, damage_=1, destructible_=true, friendly_=false, alpha_=1, draw_=c_bulletdraw, rotate_=true, sound_=se_null, onhit_=st_hurt) constructor {
